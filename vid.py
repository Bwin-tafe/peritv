...
class vid:
    def __init__(self, id : str, client : Client, author : str = "none", title : str = "none", description : str = "none", duration : float = 0, thumbnailUrl : str = "none", tags: list = [], series : str = "none", episode : int = 0):
        self.id = id
